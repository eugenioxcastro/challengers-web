...
export const DownloadButtons: React.FC = () => {
  return (
    <div className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start">
      <a
        href="#"
        className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-white/90 text-[#ff9f00] rounded-full shadow-lg shadow-black/5 hover:shadow-xl hover:shadow-black/10 transition-all duration-300 flex items-center justify-center gap-3 font-semibold backdrop-blur-sm"
      >
      ...
      <a
        href="#"
        className="w-full sm:w-auto px-8 py-4 bg-white/10 hover:bg-white/20 text-white rounded-full shadow-lg shadow-black/5 hover:shadow-xl hover:shadow-black/10 transition-all duration-300 flex items-center justify-center gap-3 font-semibold backdrop-blur-sm border border-white/20"
      >
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
